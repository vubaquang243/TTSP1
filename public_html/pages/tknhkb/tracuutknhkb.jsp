...
<div class="box_common_conten">
  <html:form action="/tracuuTKNHKB.do" method="post" >
          ...
          <div>
            <table  class="data-grid" id="data-grid" 
                ...
                <tr>
                  ...
                  <td>
                    <html:text property="so_tk" styleId="so_tk" maxlength="50"/>
                  </td>
                </tr>
                <tr>
                  <td align="right">
                  ...
                  <td class="promptText" align="right">
                    <html:select styleClass="selectBox" property="loai_tk"  
                                 styleId="loai_tk" style="width:100%;"
                  ...
                  <td class="promptText" align="right">
                    <html:select styleClass="selectBox" property="loai_gd" 
                                 ...
                                 onblur="textlostfocus(this);"  onkeydown="nextFocus();"
                                 onfocus="textfocus(this);">
                    <html:option value="" >Ch&#7885;n lo&#7841;i GD</html:option>  
                ...
                <tr>
                  <td align="right" bordercolor="#e1e1e1">Trạng thái</td>
                  <td>
                    <html:select property="trang_thai" styleId="trang_thai" onkeydown="if(event.keyCode==13) event.keyCode=9;">
                        <html:option value="">Chọn trạng thái</html:option>
                        <html:option value="01">Hoạt động</html:option>
                        <html:option value="02">Không hoạt động</html:option>
                    </html:select>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <html:select property="ma_nt" styleId="ma_nt" onkeydown="if(event.keyCode==13) event.keyCode=9;">  
                ...
                <tr>
                  ...
                  <td align="left">
                    <html:text property="hieu_luc_den_ngay" styleId="hieu_luc_den_ngay" styleClass="fieldText"
                       ...
                       style="WIDTH: 28%;"/>
                  <img src="<%=AppConstants.NNT_APP_CONTEXT_ROOT%>/styles/js/calendar/calbtn.gif"
                       border="0" id="den_ngay_btn" width="12%"
                       style="vertical-align:middle;"/>
                  <script type="text/javascript">
                    Calendar.setup( {
