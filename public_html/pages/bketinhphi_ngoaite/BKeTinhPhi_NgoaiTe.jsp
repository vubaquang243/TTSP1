...
<div class="box_common_conten">
  <html:form action="BKeTinhPhiNgoaiTeAction.do" method="post" >
    <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
      <tbody>
        <tr>
          <td width=13><img src="<%=AppConstants.NNT_APP_CONTEXT_ROOT%>/styles/images/T1.jpg" width=13 height=30/></td>
          <td background="<%=request.getContextPath()%>/styles/images/T2.jpg" width="75%">
            <span class=title2> Bảng kê tính phí ngoại tệ </span>
          </td>
          ...
          <fieldset>
            ...
            <table class="data-grid" id="data-grid" style="width:100%" border="0" cellspacing="0" cellpadding="1" >
              ...
              <tr>
                ...
                <td>
                  <html:select property="sendBank" styleId="sendBank" style="font-size:12px;width:100%" onchange="getTK_NH_KB()"
                               onkeydown="if(event.keyCode==13) event.keyCode=9;">  
                    <html:option value="">---<fmt:message key="doi_chieu.page.label.tracuu.default"/>---</html:option>  
                  </html:select>
                </td>
              ...
              <tr>
                <td align="right">Thanh toán từ ngày &nbsp;</td>
                <td>
                ...
                <td align="right">Đến ngày thanh toán &nbsp;</td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <html:select property="loaiTien" styleId="loaiTien" style="font-size:12px;width:41%" 
                               onkeydown="if(event.keyCode==13) event.keyCode=9;">  
              ...
              <tr>
                <td colspan="5" align="center">
                  ...
                  <!--<button type="button" onclick="check('tonghop');" class="ButtonCommon" accesskey="t" style="width:70pt" >
                    In <span class="sortKey">t</span>ổng hợp
                  </button>
                  <button type="button" onclick="check('chitiet');" class="ButtonCommon" accesskey="c" >
                    In <span class="sortKey">c</span>hi tiết
                  </button>-->
                </td>
              </tr>
            </table>
          ...
          <fieldset>
            ...
            <table class="data-grid" id="data-grid" border="1" cellspacing="0" cellpadding="0" width="100%">
              <tr>
                ...
                <th width="12%">Tên KB</th>
                <th width="12%">Tên NH</th>
                <th width="8%">Từ ngày</th>
                <th width="8%">Đến ngày</th>
                <th width="8%">Số tài khoản</th>
                <th width="9%">Phí</th>
                <th width="10%">Phí sau VAT</th>
                <th width="8%">In</th>
              </tr>
              <logic:notEmpty name="listPhiDetail">
                <logic:iterate id="item" name="listPhiDetail" indexId="stt">
                  <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>'>
                    ...
                    <td align="center">
                      <a href="printBKeTinhPhiNgoaiTe.do?type=tonghop&id=<bean:write name="item" property="id" />" 
                      target="_blank" >THợp</a> |
                      <a href="printBKeTinhPhiNgoaiTe.do?type=chitiet&id=<bean:write name="item" property="id" />" 
                      target="_blank" >CTiết</a>
                    </td>
                  </tr>
                </logic:iterate>
              </logic:notEmpty>
...
//      return false;
//    }
//    if(denNgay == null || "" == denNgay.trim() ){
//      alert("Nhập thông tin đến ngày.");
//      jQuery("#denNgay").focus();
//      return false;
//    }
//    if(loaiTien == null || "" == loaiTien.trim() ){
//      alert("Nhập thông tin loại tiền.");
//      jQuery("#loaiTien").focus();
//      return false;
//    }
//    
//    window.open('printBKeTinhPhiNgoaiTe.do?tuNgay='+jQuery("#tuNgay").val()+
//      '&denNgay='+jQuery("#denNgay").val()+'&soTk='+jQuery('#soTk').val()+
//      '&sendBank='+jQuery('#sendBank').val()+'&id_KB='+jQuery('#receiveBank').val()+'&loaiTien='+loaiTien+'&type='+type, '_blank');
    f.submit();
  }
</script>