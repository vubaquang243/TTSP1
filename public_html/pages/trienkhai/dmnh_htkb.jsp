      ...
      <tr>
        <td><!--<div style="clear:both;"></div>
          <ul id="green_and_orange_step_menu">
              ...
              <li class="inprogress">Bước 3<span></span></li>
          ...
          <div class="trienkhai-steps">
            ...
            <div class="active-step"><a><span>3</span>Mã NH-SHKB</a></div>
          ...
          <table class="tableTop">
            <tr>
              <td>
                <h3><i><B>TẠO LIÊN HỆ GIỮA SHKB VÀ MÃ NH CỦA KHO BẠC</B></i></h3>
                                  
                <html:hidden property="type" styleId="type"/>
                <html:hidden property="type_srv" styleId="type_srv"/>
                <html:hidden property="step" styleId="step" value="3"/>    
                <html:hidden property="ten" styleId="ten" />  
                ...
                <logic:equal value="" name="TrienKhaiForm" property="exeption">
                  <logic:equal value="INSERT" name="TrienKhaiForm" property="type_srv">
                    <font color="Red">Chưa có danh mục liên hệ giữa SHKB và mã NH của KB, hãy click GHI để lưu dữ liệu sau đó thực hiện bước tiếp theo.</font>
                  </logic:equal>
                  <logic:equal value="UPDATE" name="TrienKhaiForm" property="type_srv">
                    <font color="Blue">Đã có danh mục liên hệ giữa SHKB và mã NH của KB. Hãy thực hiện bước tiếp theo.</font>
                  </logic:equal>                
                </logic:equal>
                <table width="100%">                  
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left"><html:text property="ma_nh" styleId="ma_nh" readonly="true" styleClass="fieldText"
                      onkeypress="return numbersonly(this,event,true) "
                     onkeydown="if(event.keyCode==13) event.keyCode=9;"
                     style="WIDTH: 30%;"/>
                    </td>
