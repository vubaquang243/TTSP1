      ...
      <tr>
        <td><!--<div style="clear:both;"></div>
          <ul id="green_and_orange_step_menu">
              ...
              <li class="inprogress">Bước 7<span></span></li>                            
          ...
          <div class="trienkhai-steps">
            ...
            <div class="active-step"><a><span>8</span>Số dư</a></div>
            <div><a><span>9</span>COT</a></div>
          </div>
          <table class="tableTop">
            <tr>
              <td>
                <h3><i><B>THIẾT LẬP SỐ DƯ</B></i></h3>
                                  
                <html:hidden property="type" styleId="type"/>
                <html:hidden property="type_srv" styleId="type_srv"/>
                <html:hidden property="step" styleId="step" value="7"/>                    
                ...
                <tr>
                  ...
                  <tr>
                    <td align="right" width="10%">Ngày dư cuối:</td>
                    <td align="left">
                      <html:text property="ngay_du_cuoi" styleId="ngay_du_cuoi" styleClass="fieldText" readonly="true"
                       style="WIDTH: 15%;"/>
                    </td>
                  </tr>
                  <tr>
                    <td align="right" width="10%">Số dư ngày triển khai:</td>
                    <td align="left">
                     <html:text property="so_du" styleId="so_du" styleClass="fieldText"
