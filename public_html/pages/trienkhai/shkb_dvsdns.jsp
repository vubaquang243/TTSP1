      ...
      <tr>
        <td><!--<div style="clear:both;"></div>
          <ul id="green_and_orange_step_menu">
              ...
              <li class="inprogress">Bước 4<span></span></li>              
           ...
           <div class="trienkhai-steps">
            ...
            <div class="active-step"><a><span>4</span>SHKB-ĐVNS</a></div>
          ...
          <table class="tableTop">
            <tr>
              <td>
                <h3><i><B>THÊM MÃ DVSDNS CỦA KHO BẠC</B></i></h3>
                ...
                <html:hidden property="step" styleId="step" value="4"/>                    
                ...
                <logic:equal value="" name="TrienKhaiForm" property="exeption">
                  <logic:equal value="INSERT" name="TrienKhaiForm" property="type_srv">
                    <font color="Red">Chưa có mã DVSDNS của kho bạc. Hãy nhập mã DVSDNS và click GHI để thêm</font>
                  </logic:equal>
                  <logic:equal value="UPDATE" name="TrienKhaiForm" property="type_srv">
                    <font color="Blue">Đã có mã ĐVSDNS. Có thể sửa mã ĐVSDNS hoặc làm bước tiếp theo..</font>
                  </logic:equal>                
                </logic:equal>
                <table width="100%">                  
                  <tr>
                    <td align="right" width="10%">SHKB:</td>
                    <td align="left"><html:text property="shkb" styleId="shkb" readonly="true" styleClass="fieldText"
                  ...
                  <tr>
                    <td align="right" width="10%">Mã ĐVSDNS:</td>
                    <td align="left"><html:text property="ma_dvsdns" styleId="ma_dvsdns" styleClass="fieldText"
                      onkeypress="return numbersonly(this,event,true) "
                     onkeydown="if(event.keyCode==13) event.keyCode=9;"
                     style="WIDTH: 30%;" maxlength="7"/>
                    </td>
                  </tr>
...
<script type="text/javascript">
  function submmitTK(type) {
    if(type == 'next'){
      ...
      if(document.forms[0].ma_dvsdns.value.length != 7){
        alert('Định dạng mã ĐVSDNS không đúng.');
