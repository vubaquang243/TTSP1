...
<div class="box_common_conten">
  <html:form action="addExcTsoHachToanAction" method="post" styleId="TCuuDMuc" >
    ...
    <tbody>
      <tr>
        ...
        <td background="<%=request.getContextPath()%>/styles/images/T2.jpg" width="75%">
          <span class=title2> Thêm mới tham số hạch toán </span>
        </td>
  ...
  <table style="BORDER-COLLAPSE: collapse" border="0" cellspacing="0" class="tableBound"
    ...
    <tr>
      ...
      <fieldset>
        ...
        <td colspan="2">
            <html:select property="ma_nh" styleId="ma_nh" style="width:85%">
...
<script type="text/javascript">
  function check(type) {
      ...
      if (type == 'save') {
          ...
          f.action = 'addExcTsoHachToanAction.do';
      }
