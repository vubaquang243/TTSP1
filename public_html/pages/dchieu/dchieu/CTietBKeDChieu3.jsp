...
<div class="box_common_conten">
  <html:form action="CTietBKeDChieu3.do" method="post" >
      ...
      <tbody>
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/styles/images/T2.jpg" width="75%">
            <span class=title2> <fmt:message key="doi_chieu.page.title.ctietbkdc3"/></span>
          </td>
...
var f = document.forms[0];
    if (type == 'print') {
        ...
        f.action = 'printBKeDChieuAction.do?type=dc3&bk_id='+bk_id+'&kq_id='+kq_id;    
     ...
     if (type == 'close') {
       ...
       var bk_id= jQuery("#bk_id").val();
         if(tcuu!=null && ""!=tcuu){
            f.action = 'ViewTTinDChieu3Action.do'+tcuu+'&id='+bk_id;           
         }else if (tcuu==null || ""==tcuu){
            if(type_dc3=='bk'){
                var idxNH="<%=idxNH%>";
                if(idxNH!=null && ""!=idxNH){
                  f.action = 'DChieu3Action.do?idxNH='+idxNH;
                }else{
                f.action = 'DChieu3Action.do';
                }
                
            }else if(type_dc3=='kq'){
              f.action = 'ListXNDChieu3Action.do';
            }
      } 
         f.submit();
}
