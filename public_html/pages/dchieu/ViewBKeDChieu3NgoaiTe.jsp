...
var tcuu="<%=tcuu%>";
    if (type == 'print') {
        ...
        f.action = 'printTTinDChieu3NgoaiTeAction.do?type=kqdc3&kq_id='+kq_id+'&lan_dc='+lan_dc;    
     ...
     if (type == 'close') {
         ...
         if(tcuu!=null && ""!=tcuu){
        f.action = 'FindTTinDChieu3NgoaiTeAction.do'+tcuu;           
         }else if (tcuu==null || ""==tcuu){
         f.action = 'TCuuTTinDChieu3NgoaiTeAction.do';
      }
         f.submit();
      }
      if (type == 'view') {
        var bk_id= jQuery("#bkid").val();
         f.action = 'CTietBKeDChieu3NgoaiTe.do'+tcuu+'&loai_dc=3&bk_id='+ bk_id;
         f.submit();
      } 
}
 bton();
