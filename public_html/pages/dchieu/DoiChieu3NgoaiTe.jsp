...
<div class="box_common_conten">
  ...
  <html:form action="THienDChieu3NgoaiTeAction.do" method="post" styleId="frmBangKeDC3NgoaiTe">
  ...
  var f = document.forms[0];	
      ...
      if (type == 'view') {
        ...
        var idxNH = jQuery('#abc option:selected').index();
         f.action = 'CTietBKeDChieu3NgoaiTe.do?type=bk&bk_id='+bk_id+"&idxNH="+idxNH;
   ...
   function change() {
      ...
      ma=jQuery('#abc').val();
      if(ma!=null && ''!=ma){
       frm.action = 'DChieu3NgoaiTeAction.do?nhkb_nhan='+ma;
      }
       frm.submit();
  } 
