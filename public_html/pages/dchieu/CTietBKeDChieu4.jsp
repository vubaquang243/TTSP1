...
<div class="box_common_conten">
  <html:form action="CTietBKeDChieu4.do" method="post" >
...
var f = document.forms[0];
    if (type == 'print') {
        ...
        f.action = 'printBKeDChieu4Action.do?type=dc3&bk_id='+bk_id+'&kq_id='+kq_id;    
     ...
     if (type == 'close') {
       ...
       var bk_id= jQuery("#bk_id").val();
         if(tcuu!=null && ""!=tcuu){
            f.action = 'ViewTTinDChieu4Action.do'+tcuu+'&id='+bk_id;           
         }else if (tcuu==null || ""==tcuu){
            if(type_dc3=='bk'){
                var idxNH="<%=idxNH%>";
                if(idxNH!=null && ""!=idxNH){
                  f.action = 'DChieu4Action.do?idxNH='+idxNH;
                }else{
                f.action = 'DChieu4Action.do';
                }
                
            }else if(type_dc3=='kq'){
              f.action = 'ListXNDChieu4Action.do';
            }
      } 
         f.submit();
}
