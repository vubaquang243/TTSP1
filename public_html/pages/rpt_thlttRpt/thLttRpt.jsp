...
<TABLE width="99%">
                <TBODY>
                  <TR>
                    <TD><div class="app_error">
  <html:errors/>
</div></TD>
                  </TR>
                </TBODY>
</TABLE>
  <html:form action="/bangTHLTTAction.do">
     <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
        <tbody>
          <tr>
            <td width="13"><img width="13" height="30" src="<%=request.getContextPath()%>/styles/images/T1.jpg"></img></td>
            <td width="75%" background="<%=request.getContextPath()%>/styles/images/T2.jpg"><span class="title2"><fmt:message key="reports.ltt.thltt.title"/></span></td>
    ...
    <tbody>
      ...
      <tr>
       ...
       <td align="left" valign="middle" width="120">
          <html:text property="tu_ngay" styleId="tu_ngay" styleClass="fieldTextCode"
       ...
       <td class="promptText" align="left" valign="middle" width="120">
