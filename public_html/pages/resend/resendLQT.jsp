...
<script type="text/javascript">
  ...
  jQuery(document).ready(function () {
      ...
      frmTraCuuLQT = jQuery("#frmTraCuuLQT");
...
//      });
      ...
      jQuery("#btn_timKiem").click(function () {
          ...
          frmTraCuuLQT.attr( {
              action : 'resendLQTListAction.do' + target
          });
          frmTraCuuLQT.submit();
      });
      //**************************BUTTON Thoat CLICK********************************************
  ...
  jQuery("#frmTraCuuLQT").target='';
      jQuery("#frmTraCuuLQT").attr( {
          action : 'resendLQTAction.do' + target
      });
      jQuery("#pageNumber").val(page);
      jQuery("#frmTraCuuLQT").submit();
  }
  ...
  function formAction(type) {       
      ...
      if(lstId!=""){
        f.action = "resendLTTAction.do?type="+type+"&lstId="+lstId+"&loai_tt=LQT";
      }else{
...
<html:form action="/resendLQTListAction.do" styleId="frmTraCuuLQT">
      ...
      <tr>
        ...
        <td class="promptText" align="right" valign="middle" width="100">
          <html:select onkeydown="if(event.keyCode==13) event.keyCode=9;"
                       styleClass="fieldText" style="width:145px;height:20px;"
                       tabindex="103"
                       property="loai_qtoan" styleId="loai_qtoan">
                       <html:option value="">
              Chọn loại quyết toán
            </html:option>
            <html:option style="COLOR: red;" value="01">
              Thu
            </html:option>
            <html:option style="COLOR: blue;" value="02">
              Chi
            </html:option>
          </html:select>
        </td>
        ...
        <td class="promptText" align="right" width="100">
            <html:text tabindex="104" property="so_tien"  onkeypress="return numbersonly(this,event,true)"
                   styleClass="fieldTextRight" onkeydown="if(event.keyCode==13) event.keyCode=9;"
                   onblur="if (this.value !='') {changeValue(this.value);}" styleId="so_tien" maxlength="20"  style="WIDTH: 150px;"/>
        </td>
      </tr>
      <tr>
        <td align="right" width="100">
        ...
        <td class="promptText" align="left" valign="middle">
          <html:text property="ngay_qtoan" styleId="ngay_qtoan" styleClass="fieldText"
                     onkeypress="return numbersonly(this,event,true) "
                     onblur="javascript:mask(this.value,this,'2,5','/');CheckDate(this);CheckDateOnClient('ngay_qtoan');"
                     onkeydown="if(event.keyCode==13) event.keyCode=9;"
                     tabindex="107"
                     style="WIDTH: 77%;"/>
          <img src="<%=AppConstants.NNT_APP_CONTEXT_ROOT%>/styles/js/calendar/calbtn.gif"
               border="0" id="ngay_qtoan_btn" width="16%"
               style="vertical-align:middle;"/>
          <script type="text/javascript">
            Calendar.setup( {
                inputField : "ngay_qtoan", // id of the input field
                ifFormat : "%d/%m/%Y", // the date format
                button : "ngay_qtoan_btn"// id of the button
            });
          </script>
          ...
          <logic:notEmpty name="lstLTT">
            ...
            <logic:iterate id="items" name="lstLTT" indexId="stt">
                ...
                <td width="12%" height="15px;" align="center">
                    <bean:write name="items" property="ma_tchieu_gd"/>
                ...
                <logic:equal property="trang_thai" value="03" name="items">
                  Đã duyệt
                </logic:equal>
                <logic:equal property="trang_thai" value="11" name="items">
                  Chờ chạy giao diện 
                </logic:equal>
                <logic:equal property="trang_thai" value="13" name="items">
                  Giao diện không thành công
                </logic:equal>
                <logic:equal property="trang_thai" value="16" name="items">
                  Lỗi truyền tin
                </logic:equal>
                </td>
