...
<script type="text/javascript">
  ...
  jQuery(document).ready(function () {
      ...
      frmTraCuuBKLQT = jQuery("#frmTraCuuBKLQT");
...
//      });
      ...
      dialog_confirm.dialog( {
          autoOpen : false, resizable : false, height : 200, width : 380, modal : true, buttons :  {
              "Có" : function () {
                  ...
                  frmTraCuuBKLQT.target='';
                  frmTraCuuBKLQT.submit();
              },
              "Không" : function () {
                  jQuery(this).dialog("close");
              }
      ...
      jQuery("#btn_timKiem").click(function () {
          ...
          frmTraCuuBKLQT.attr( {
              action : 'resendBKLQTListAction.do' + target
          });
          frmTraCuuBKLQT.submit();
      });
      //**************************BUTTON Thoat CLICK********************************************
  ...
  jQuery("#frmTraCuuBKLQT").target='';
      jQuery("#frmTraCuuBKLQT").attr( {
          action : 'resendBKLQTAction.do' + target
      });
      jQuery("#pageNumber").val(page);
      jQuery("#frmTraCuuBKLQT").submit();
  }
  ...
  function formAction(type) {       
      ...
      for(var i=0, n=checkboxes.length;i<n;i++) {    
         if(checkboxes[i].checked){
            var pLoai_ht = document.getElementById("tblBlah").rows[i+1].cells[8].childNodes[0];             
            lstId += pLoai_ht.value+",";
         }
      }      
      if(lstId!=""){
        f.action = "resendLTTAction.do?type="+type+"&lstId="+lstId+"&loai_tt=BKLQT";
      }else{
...
<html:form action="/resendBKLQTListAction.do" styleId="frmTraCuuBKLQT">
    ...
    <tbody>
      <tr>
            ...
            <td width="75%" background="<%=request.getContextPath()%>/styles/images/T2.jpg"><span class="title2">
             XỬ LÝ TRUYỀN TIN BẢNG KÊ LQT</span></td>
      ...
      <tr>
        ...
        <td class="promptText" align="left" valign="middle">
          ...
          <img src="<%=AppConstants.NNT_APP_CONTEXT_ROOT%>/styles/js/calendar/calbtn.gif"
               border="0" id="ngay_qtoan_btn" width="10%"
        ...
        <logic:present name="lstLTT">
          ...
          <logic:notEmpty name="lstLTT">
            ...
            <logic:iterate id="items" name="lstLTT" indexId="stt">
                ...
                <logic:equal property="trang_thai" value="02" name="items">
                  Đã kiểm soát
                </logic:equal>
                </td>
