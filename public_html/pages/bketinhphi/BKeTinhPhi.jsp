...
<div class="box_common_conten">
  <html:form action="bkeTinhPhi.do" method="post" >
    <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
      <tbody>
        <tr>
          <td width=13><img src="<%=AppConstants.NNT_APP_CONTEXT_ROOT%>/styles/images/T1.jpg" width=13 height=30/></td>
          <td background="<%=request.getContextPath()%>/styles/images/T2.jpg" width="75%">
            <span class=title2> Bảng kê tính phí </span>
          </td>
          ...
          <fieldset>
            ...
            <table class="data-grid" id="data-grid" border="1" cellspacing="0" cellpadding="0" width="100%">
              <tr>
                ...
                <th width="10%">Số MSG</th>
                <th width="15%">Tên KB</th>
                <th width="14%">Tên NH</th>
                <th width="8%">Từ ngày</th>
                <th width="8%">Đến ngày</th>
                <th width="9%">Số tài khoản</th>
                <th width="9%">Phí</th>
              ...
              <logic:notEmpty name="listPhiDetail">
                <logic:iterate id="item" name="listPhiDetail" indexId="stt">
                  <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>'>
                    ...
                    <td align="center">
                      <a href="printBKeTinhPhi.do?id=<bean:write name="item" property="id" />" 
                      target="_blank" >In</a>
                    </td>
                  </tr>
                </logic:iterate>
...
//    }
//    if(type == 'print'){
//        window.open('printBKeTinhPhi.do?tu_ngay='+ jQuery("#tuNgay").val()+'&den_ngay='
//        +jQuery("#denNgay").val() +'&so_tk='+jQuery('#soTk').val()+'&send_bank=' +jQuery('#sendBank').val()+ '&id_KB=' + jQuery('#receiveBank').val(), '_blank');
//        return false;
//    }
    f.submit();
  }
