  ...
  <form action="lovAction.do" method="post">
    <table style="width:100%;height:100%;">
      <tr>
        ...
        <td>T&ecirc;n</td>
        <td>
          <input type="text" name="ten_lov" id="ten_lov" size="40" onkeydown="if(event.keyCode==13) fillLovDMKBTCUU();"/>
          ...
          <input type="hidden" name="id_field_id_lov" id="id_field_id_lov"/>
           ...
           <input type="hidden" name="id_cha_field_id_lov" id="id_cha_field_id_lov"/>
        </td>
        <td>
          <button type="button" name="btnSearch" onclick="fillLovDMKBTCUU();">T&igrave;m</button>
        </td>
      </tr>
    </table>
    <br></br>
