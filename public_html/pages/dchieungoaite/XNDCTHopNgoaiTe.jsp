...
//      height: "350px",
      ...
      loai_tien = document.getElementById("loai_tien_idx_"+sttNext).value;
      so_thu = jQuery("#dia_txt_thu_tcong").val();
      so_chi=jQuery("#dia_txt_chi_tcong").val();
      ...
      //----
        var f = document.forms[0];
         f.action = 'ThuChiTCongNgoaiTeAction.do?noi_dung='+noi_dung+'&dia_txt_thu_tcong='+so_thu+'&loai_tien='+loai_tien+'&dia_txt_chi_tcong='+so_chi+'&id_tcong='+jQuery("#dia_id").val()+'&ma_nh='+ma_nh+'&ngay_dc='+ngay_dc+'&pht_id='+pht_id+'&ttsp_id='+ttsp_id+'&loai_gd='+'<%=loai_gd%>';
         f.submit();
...
<div class="box_common_conten">
  <html:form action="XNDCTHopNgoaiTeAction.do" method="post" >
   <table border="0" cellspacing="0" cellpadding="0" width="100%"
    ...
    <table style="BORDER-COLLAPSE: collapse" border="0" cellspacing="0" class="tableBound"
      ...
      <tr>
       <td width="42%" align="center" colspan="4" >
        ...
        <div  style="height:370px;overflow-y: scroll;">
          <table  class="data-grid" id="data-grid" style="width:100%" border="1" cellspacing="0" cellpadding="2" >
                 <tr>
                 ...
                 <td align="center" style="width:17%" class="ui-state-default ui-th-column">Loại tiền</td>
               ...
               <logic:notEmpty name="colDChieu">
                 ...
                 <tr class="ui-widget-content jqgrow ui-row-ltr" 
                   ...
                   <td align="center"><b style="color:#006666;">
                     <bean:write name="UDlist" property="loai_tien"/>
                   </b></td>
                   ...
                   <input type="hidden" name="loai_tien_idx" id="loai_tien_idx_<bean:write name="index"/>" value="<bean:write name="UDlist" property="loai_tien"/>" />
      ...
      <logic:equal value="VND" name="XNDCTHop1Form" property="loai_tien">
            ...
            <div style="height:370px;">
              <table width="100%" cellspacing="0" cellpadding="2"
                 ...
                 <tr>
                  ...
                  <!--20171009 thuongdt bo sung  du lieu thu ngay thu 7 phuc vu view du lieu cua ngay nghi start-->
                 <logic:notEmpty name="colPHT_T7">
                  ...
                  <!--20171009 thuongdt bo sung  du lieu thu ngay thu 7 phuc vu view du lieu cua ngay nghi end-->
              </table>
              <br/>
               <fieldset>
               <div>
              <table width="100%" cellspacing="0" cellpadding="2"
                    ...
                    <logic:notEmpty name="colGDTCong">
                        ...
                        <!--20171009 thuongdt bo sung so chi thu cong start-->
                      <tr> 
                      ...
                      <tr>
                        <td  align="left">
                          ...
                          <td  align="right"> 
                          <input type="text"  name="so_chi"  title="<bean:write name="items" property="so_chi_chu"/>"  disabled="disabled"  id="so_chi"   value="<fmt:formatNumber type="currency"  currencySymbol=""><bean:write name="items" property="so_chi"/></fmt:formatNumber>" class="fieldTextRight" />                                   
                      ...
                      <!--20171009 thuongdt bo sung so chi thu cong end-->
                      </logic:iterate>
                      </logic:notEmpty>
                      ...
                      <logic:notEmpty name="colTHDC">
                        ...
                        <tr>
                          ...
                          <b>Số dư tại thời điểm Cut-off-time: 
                            <fmt:formatNumber type="number" pattern="#,##0.00;-#,##0.00">
                      ...
                      <tr> 
                        <td width="25%" align="left">
                         ...
                         <td width="25%" align="right">                                       
                          <input type="text"  name="txt_thu_tcong" disabled="disabled"  id="txt_thu_tcong" onkeyup="checkKey('txt_thu_tcong')"  value="<fmt:formatNumber  type="currency"  currencySymbol=""><bean:write name="items" property="ket_chuyen_thu"/></fmt:formatNumber>" class="fieldTextRight" />
                        ...
                        <td  align="left">
                          ...
                          <td  align="right"> 
                          <input type="text"  name="txt_chi_tcong" disabled="disabled"  id="txt_chi_tcong" onkeyup="checkKey('txt_chi_tcong')"   value="<fmt:formatNumber  type="currency"  currencySymbol=""><bean:write name="items" property="ket_chuyen_chi"/></fmt:formatNumber>" class="fieldTextRight" />                                   
                      ...
                      <logic:empty name="colTHDC">
                        <tr>
                          <td colspan="4">
                            <b>Số dư tại thời điểm Cut-off-time: <fmt:formatNumber  type="currency"  currencySymbol=""></fmt:formatNumber></b> 
                          </td>
                        </tr>
                      <tr> 
                        <td width="25%" align="left">
                 ...
                 style="BORDER-COLLAPSE: collapse;table-layout:fixed">       
                    <thead >
                        ...
                        <th  bgcolor="#f0f0f0"  align="center" width="12%">
                         ...
                         <th  bgcolor="#f0f0f0" align="center" width="16%">                                   
                            Ghi chú
                         </th>
                         <th  bgcolor="#f0f0f0" align="center" width="6%">                                   
                           Trạng thái
                      ...
                      <logic:notEmpty name="col066">
                        ...
                        <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>' id="066_row_qt_<bean:write name="stt"/>">
                          ...
                          <td align="right">
                            <b><fmt:formatNumber  type="currency"  currencySymbol="">
...
var chkdate="<%=chkdate%>";
    var strRowSelected="<%=strRowSelected%>";
      ...
      trang_thai=document.getElementById("tthai_"+sttNext).value;
            ...
            jQuery.ajax( {
                type : "POST", 
                url : "updateTCongNgoaiTeAction.do", 
                data :  { "loai_ts" : type     
                },   
...
//  var qtoan_ko_dchieu="<%=qtoan_ko_dchieu%>";
  ...
  stt= strRowSelected.substr(7,5);
  sttNext=parseInt(stt);
  var loai_tien = document.getElementById("loai_tien_idx_"+sttNext).value;
      ...
      if (type == 'create') {
          ...
          if(strRowSelected!=null && '' != strRowSelected){
              if('Y'==qtoan_ko_dchieu || qtoan_ko_dchieu=='Y'){
                  ...
                  document.getElementById("bt").disabled=true;
                  f.action = 'TaoDXNDCTHopNgoaiTeAction.do?rowSelected='+strRowSelected+"&type=C&ngay_dc="+ngay_dc+"&receive_bank="+receive_bank+"&loai_gd="+notTTSP+"&loai_kq066="+kq_ttsp+kq_pht+"&tthai_dxn_thop="+trang_thai+"&ttsp_id="+ttsp_id+"&loai_tien="+loai_tien;
              }else{
                  tthai_kq=document.getElementById("tthaikq_"+sttNext).value;    
                  if(tthai_kq!='02'){                      
                      ...
                      document.getElementById("bt").disabled=true;
                      f.action = 'TaoDXNDCTHopNgoaiTeAction.do?rowSelected='+strRowSelected+"&type=C&ngay_dc="+ngay_dc+"&loai_gd="+notTTSP+"&loai_kq066="+kq_ttsp+kq_pht+"&tthai_dxn_thop="+trang_thai+"&ttsp_id="+ttsp_id+"&loai_tien="+loai_tien;
                  }  
              }
          }
      }
                 ...
                 ngay_dc=document.getElementById("ngay_dc_idx_"+sttNext).value;
                   ...
                   ttsp_id = document.getElementById("idx_"+sttNext).value;
                    if(strRowSelected!=null && '' != strRowSelected){
                          ...
                          document.getElementById("bt").disabled=true;
                                f.action = 'TaoDXNDCTHopNgoaiTeAction.do?rowSelected='+strRowSelected+"&type=XN&ngay_dc="+ngay_dc+"&loai_gd="+notTTSP+"&ttsp_id="+ttsp_id+"&loai_tien="+loai_tien;
                            }
                    }
        }
      if (type == 'print') {
          ...
          f.action = 'PrintXNDCTHopNgoaiTeAction.do?type=065&ket_qua_pht='+kq_pht+"&ket_qua_ttsp="+kq_ttsp+'&ttsp_id='+ttsp_id+"&loai_tien="+loai_tien;    
  ...
  function chk_print(type,bk_id,kq_dxn_Thop) {
      if (type == 'print') {
          f.action = 'PrintXNDCTHopNgoaiTeAction.do?type=066&id_066='+bk_id+"&loai_kq066="+kq_dxn_Thop;    
          var params = ['scrollbars=1,height='+(screen.height-100),'width='+screen.width].join(',');            
          newDialog = window.open('', '_form', params);  
          f.target='_form';      
      }
