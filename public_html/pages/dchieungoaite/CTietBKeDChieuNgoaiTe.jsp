        ...
        <legend><font color="Blue">T&#7893;ng h&#7907;p b&#7843;ng k&#234;</font></legend>
         <div >  
          <table width="80%" cellspacing="0" cellpadding="1"
            ...
            <thead>
              <tr>
                <th width="20%">Loại tiền</th>
                <th width="20%"><fmt:message key="doi_chieu.page.lable.sdudngay"/></th>
                <th width="20%"><fmt:message key="doi_chieu.page.lable.sducutoff"/></th>
                <th width="20%">Tổng thu điện tử</th>
                <th width="20%">Tông chi điện tử</th>
              </tr>
            </thead>
            ...
            <logic:notEmpty name="colThop">
               <logic:iterate id="UDlist" name="colThop" indexId="index">
                 <tr>
                  ...
                  <td align="right">
                    <fmt:formatNumber type="currency" currencySymbol="">
                      <bean:write  name="UDlist" property="so_du"/>
                    </fmt:formatNumber>
                  </td>
                  <td align="right">
                    <fmt:formatNumber type="currency" currencySymbol="">
...
function check(type) {
    ...
    if (type == 'close') {
       ...
       if(tcuu!=null && ""!=tcuu){
          ...
          if(type_dc1=='bk'){
              f.action = 'DChieuNgoaiTeAction.do';
          }else if(type_dc1=='kq'){
              f.action = 'DuyetDChieuNgoaiTeAction.do';
          }
       } 
    }
    f.submit();
