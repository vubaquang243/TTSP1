...
<script type="text/javascript">
  ...
  jQuery(document).init(function () {
    ...
    if(strDuyet!=null && '' != strDuyet){
        ...
        var rowNextSelect = "row_qt_"+(parseInt(strRowSelected.charAt(strRowSelected.length-1))+1);
        document.getElementById(rowNextSelect).click();
    }
...
<div class="box_common_conten">
  <html:form action="DuyetXNDCTHopNgoaiTeAction.do" method="post" >
  <!--manhnv-24/06/2013-->
       ...
       <td width="50%">
        ...
        <div  style="height:390px;overflow-y: scroll;">
          <table  class="data-grid" id="data-grid" 
                 ...
                 <td align="center" width="13%" class="ui-state-default ui-th-column">Loại tiền</td>
               ...
               <logic:notEmpty name="colDChieu">
                 ...
                 <tr class="ui-widget-content jqgrow ui-row-ltr" 
                      ...
                      onclick="rowSelectedFocusXNDC('row_qt_<bean:write name="index"/>');
                               fillDataDuyetXNTH('DuyetXNDCTHopNgoaiTeAction.do',
                   ...
                   <input type="hidden" name="loaitien_hidden" id="loaitien_<bean:write name="index"/>" value="<bean:write name="UDlist" property="loai_tien"/>" />
                   </td>
                 </tr>
                  </logic:iterate>
                </logic:notEmpty>             
                    ...
                    <logic:notEmpty name="colTHDC">
                      ...
                      <tr> 
                        <td width="25%" align="left">
                         ...
                         <td width="25%" align="right">                                       
                          <input type="text"  name="txt_thu_tcong" style="width:99%" disabled="disabled"  id="txt_thu_tcong" onkeyup="checkKey('txt_thu_tcong')"  value="<fmt:formatNumber  type="currency"  currencySymbol=""><bean:write name="items" property="ket_chuyen_thu"/></fmt:formatNumber>" class="fieldTextRight" />
                        ...
                        <td  align="left" width="25%">
                          ...
                          <input type="text"  name="txt_chi_tcong" style="width:99%" disabled="disabled"  id="txt_chi_tcong" onkeyup="checkKey('txt_chi_tcong')"   value="<fmt:formatNumber  type="currency"  currencySymbol=""><bean:write name="items" property="ket_chuyen_chi"/></fmt:formatNumber>" class="fieldTextRight" />                                   
                    ...
                    <logic:empty name="colTHDC">                    
                      ...
                      <tr> 
                        <td width="25%" align="left">
                         ...
                         <td width="25%" align="right">                                       
                          <input type="text"   style="width:99%" name="so_thu" disabled="disabled"  id="so_thu" value="<fmt:formatNumber  type="currency"  currencySymbol=""><bean:write name="items" property="so_thu"/></fmt:formatNumber>" class="fieldTextRight"/>                    
                          </td>
                      ...
                      <tr> 
                        <td  align="left">
                          ...
                          <td  align="right"> 
                          <input type="text"  style="width:99%" name="so_chi" disabled="disabled"  id="so_chi" value="<fmt:formatNumber  type="currency"  currencySymbol=""><bean:write name="items" property="so_chi"/></fmt:formatNumber>" class="fieldTextRight"/>                                   
                         </td>            
                      </tr>
                      <tr>
                          <td colspan="4">
                          <b>Số dư tại thời điểm Cut-off-time: 
                            <fmt:formatNumber  type="currency"  currencySymbol=""></fmt:formatNumber></b> 
                          </td>
                        </tr>
                      <tr> 
                        <td width="25%" align="left">
                 ...
                 style="BORDER-COLLAPSE: collapse">       
                    <thead>
                      <tr>
                        ...
                        <th  bgcolor="#f0f0f0" align="center"  width="10%"> 
                          QT thu
                        </th>                                 
                        <th  bgcolor="#f0f0f0"  align="center" width="10%">
                            QT chi
                        ...
                        <th  bgcolor="#f0f0f0" align="center" width="13%">                                   
                            Ghi chú
                        </th>
                        <th  bgcolor="#f0f0f0" align="center" width="8%">                                   
                           Trạng thái
                        </th>
                      ...
                      <logic:notEmpty name="col066">
                        ...
                        <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>' id="066_row_qt_<bean:write name="stt"/>">
                          ...
                          <logic:equal value="01" property="trang_thai" name="items">
                              ...
                              <button type="button" onclick="check('duyet','<bean:write name="items" property="id"/>','<bean:write name="items" property="loai_qtoan"/>')" accesskey="D"  id="bt" name="btton">
                                  <span class="sortKey">D</span>uy&#7879;t
                              </button>
                              <button type="button" onclick="check('huy','<bean:write name="items" property="id"/>','<bean:write name="items" property="loai_qtoan"/>')"  id="huy_bt" accesskey="H"  name="btton">
                                  <span class="sortKey">H</span>&#7911;y
                              </button>
                                  <%}%>
...
//      var ndung_ky_066 = jQuery('#ndung_ky_066_'+id_066).val();
     if (type == 'duyet') {
        if (""==id|| id==null ){
          if(id_066!=null && ''!=id_066){
           stt= parseInt(strRowSelected.substr(7,5));
            ...
            loai_tien=document.getElementById("loaitien_"+sttNext).value;
          ...
          f.action = 'exDuyetXNDCTHopNgoaiTeAction.do?rowSelected='+strRowSelected+'&ngay_dc='+ngay_dc+'&id_066='+id_066+"&tthai_dxn_thop="+tthai_dxn+"&loai_qtoan="+loai_qtoan+"&loai_tien="+loai_tien;  
          }else{
      ...
      //manhnv-24/06/2013
       stt= parseInt(strRowSelected.substr(7,5));
        ...
        tthai_dxn=document.getElementById("tthai_"+sttNext).value;
        loai_tien=document.getElementById("loaitien_"+sttNext).value;
        f.action = 'exDuyetXNDCTHopNgoaiTeAction.do?rowSelected='+strRowSelected+'&id='+id+'&ngay_dc='+ngay_dc+'&id_066='+id_066+"&tthai_dxn_thop="+tthai_dxn+"&loai_qtoan="+loai_qtoan+"&loai_tien="+loai_tien;    
      }        
      }
      if (type == 'huy') {
          ...
          if (""==id|| id==null ){
            ...
            var r = confirm("Xác nhận hủy điện 066?");
              if (r == true){
                  ...
                  ngay_dc =document.getElementById("ngaydc_"+stt).value;
                  loai_tien=document.getElementById("loaitien_"+sttNext).value;
                  f.action = 'HuyXNDCTHopNgoaiTeAction.do?rowSelected='+strRowSelected+'&ngay_dc='+ngay_dc+'&id_066='+id_066+"&loai_tien="+loai_tien; 
              }
              else{
                  return false;
              }
          ...
          var r = confirm("Xác nhận không duyệt ?");
              if (r == true)
                ...
                stt= parseInt(strRowSelected.substr(7,5));
                  ngay_dc =document.getElementById("ngaydc_"+stt).value;
                  loai_tien=document.getElementById("loaitien_"+sttNext).value;
                  f.action = 'HuyXNDCTHopNgoaiTeAction.do?rowSelected='+strRowSelected+'&id='+id+'&ngay_dc='+ngay_dc+'&id_066='+id_066+"&loai_qtoan="+loai_qtoan+"&loai_tien="+loai_tien;   
                  }
                  else
                    {
                    return false;
    ...
    if (type == 'print') {
        f.action = 'PrintXNDCTHopNgoaiTeAction.do';    
        ...
        if('' != size && size != null && '0' != size && size > 0){
            for (i = 0; i < size; i++){
                ...
                if(trang_thai != '03'){
                    ...
                    if(jQuery('#trang_thai_'+i).val() == '01'){           
