...
<div class="box_common_conten">
  <html:form action="DuyetDChieuNgoaiTeAction.do" method="post" >
  <!--manhnv-24/06/2013-->
  ...
  <fmt:setLocale value="en_US"/>
   <table border="0" cellspacing="0" cellpadding="0" width="100%"
      ...
      <tr>
               ...
               <logic:notEmpty name="colDChieu">
                 ...
                 <tr class="ui-widget-content jqgrow ui-row-ltr" 
                      ...
                      onclick="rowSelectedFocusXNDC('row_qt_<bean:write name="index"/>');
                               fillDataDuyetXNDC('DuyetDChieuNgoaiTeAction.do','<bean:write name="UDlist" property="mt_id"/>','row_qt_<bean:write name="index"/>');">
       ...
       <td width="40%">
         <fieldset>
            ...
            <div style="height:155px;WIDTH: 100%; OVERFLOW-Y: scroll">
              ...
              <logic:notEmpty name="colTHBKDC">
                ...
                <tbody>
                <tr>
                  <th align="center"><bean:write name="items" property="loai_tien" /></th>
                    <td align="right">
                    <fmt:formatNumber type="currency" currencySymbol="">
                      <bean:write name="items" property="sotien_thu" />
                    </fmt:formatNumber>
                    </td>
                    <td align="right">
                      <fmt:formatNumber type="currency" currencySymbol="">
                        <bean:write name="items" property="sotien_chi" />
                      </fmt:formatNumber>
                    </td>
                </tr>
                </tbody>
              ...
              <table width="80%" cellspacing="0" cellpadding="2"
                 ...
                 <logic:empty name="colTHBKDC">
                    <tr>
                      ...
                      <td><input type="text" name="ly_do" class="fieldText" /></td>
                    </tr>
                    <tr>
                      <td width="25%">
                  ...
                  <logic:notEmpty name="colTHBKDC">
                    <tr>
                      ...
                      <td width="25%">
                        <!-- chua doi chieu-->
                        <c:if test="${requestScope.colTHBKDC[0].ket_qua == 0}">
                        ...
                        <c:if test="${requestScope.colTHBKDC[0].ket_qua == 1}">
                      ...
                      <td>Lý do chênh lệch</td>
                      <td><input type="text" name="ly_do" id="ly_do" value="<c:out value="${requestScope.colTHBKDC[0].ly_do_chenh_lech}"/>" class="fieldTextRight" readonly="true" /></td>
                    </tr>
                    <tr>
                      <td  width="25%">
                        -<fmt:message key="doi_chieu.page.lable.duyet.lttthua" />
                      ...
                      <td width="25%">
                        <input type="text" name="ltt_kb_thua" id="ltt_kb_thua" class="fieldTextRight" value="<c:out value="${requestScope.colTHBKDC[0].ltt_kb_thua}" />" readonly="true"/>
                      </td>
                      <td width="25%">
                        -<fmt:message key="doi_chieu.page.lable.duyet.dtsthua"/>
                      </td>
                      <td width="25%">
                        <input type="text" name="dts_kb_thua" id="dts_kb_thua" class="fieldTextRight" value="<c:out value="${requestScope.colTHBKDC[0].dts_kb_thua}" />" readonly="true"/>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <input type="text" name="ltt_kb_thieu" id="ltt_kb_thieu" class="fieldTextRight" value="<c:out value="${requestScope.colTHBKDC[0].ltt_kb_thieu}" />" readonly="true"/>
                      </td>
                      <td>
                        -<fmt:message key="doi_chieu.page.lable.duyet.dtsthieu"/>
                      </td>
                      <td>
                        <input type="text" name="dts_kb_thieu" id="dts_kb_thieu" class="fieldTextRight" value="<c:out value="${requestScope.colTHBKDC[0].dts_kb_thieu}" />" readonly="true"/>
                      </td>
                    </tr>
                  </logic:notEmpty>
              </table>
      ...
      <tr>
        ...
        <div class="tabbertab" style="height:150px;overflow-y: scroll;"><h2>L&#7879;nh thanh to&#225;n</h2>           
          <table width="100%" cellspacing="0" cellpadding="1" 
              ...
              <tr>
                <td colspan="10" style="color:red"><b>Kh&#244;ng c&#243; th&#244;ng tin</b></td>
              </tr>
              </logic:empty>
    ...
    <td align="right" colspan="7">
      <logic:notEmpty name="colTHBKDC">
          <c:if test="${requestScope.colTHBKDC[0].trang_thai_kqdc == '01' && param.mt_id == null}">
            <c:set var="mt_id_selected" value="${requestScope.colDChieu[0].mt_id}"/>
            <button type="button" onclick="check('del','<bean:write name="mt_id_selected"/>')" accesskey="h" id="bt" style="width:60px" name="btton">
              <span class="sortKey">H</span>&#7911;y
            </button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            <button type="button" onclick="check('duyet','<bean:write name="mt_id_selected"/>')" accesskey="d" id="bt" style="width:60px" name="btton">
              <span class="sortKey">D</span>uy&#7879;t
            </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
          </c:if>
          <c:if test="${requestScope.colTHBKDC[0].trang_thai_kqdc == '01' && param.mt_id != null}">
            <c:set var="mt_id_selected" value="${param.mt_id}"/>
            <button type="button" onclick="check('del','<bean:write name="mt_id_selected"/>')" accesskey="h" id="bt" style="width:60px" name="btton">
              <span class="sortKey">H</span>&#7911;y
            </button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            <button type="button" onclick="check('duyet','<bean:write name="mt_id_selected"/>')" accesskey="d" id="bt" style="width:60px" name="btton">
...
<script type="text/javascript">
  ...
  function check(type,id) {        
     if (type == 'del') {
        ...
        f.action = 'DuyetDChieuNgoaiTeAction.do?btton=huy&mt_id='+id+'&bk_id='+bk_id;          
     }
     if (type == 'view') {
        if(strRowSelected!=null && '' != strRowSelected){
          stt= strRowSelected.substr(7,5);
          sttNext=parseInt(stt);
          bk_id=document.getElementById("bkid_"+sttNext).value;
          f.action = 'CTietBKeDChieuNgoaiTe.do?type=kq&mt_id='+bk_id;
        }
     }
     if (type == 'duyet') {
     //manhnv-24/06/2013
      ...
      //manhnv-24/06/2013
        f.action = 'DuyetDChieuNgoaiTeAction.do?btton=duyet&mt_id='+id;          
     }
     if (type == 'print') {
