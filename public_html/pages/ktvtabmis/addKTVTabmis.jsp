...
<script type="text/javascript">
  ...
  function sbKTVTabmis(type) {
      ...
      if (f.ma.value.length >= 50) {
        ...
        if (f.ten.value == "" && f.ma.value == "") {
              alert('<fmt:message key="ktvtabmis.listktvtabmis.warning.add.null"/>');
              f.ma.focus();
              return;
          }
          else if (f.ten.value == null || f.ten.value == "") {
              alert('<fmt:message key="ktvtabmis.listktvtabmis.warning.add.tennull"/>');
              f.ten.focus();
              return;
          }
          else if (f.ma.value == null || f.ma.value == "") {
              alert('<fmt:message key="ktvtabmis.listktvtabmis.warning.add.manull"/>');
              f.ma.focus();
              return;
          }
          else if (f.ma.value.length > 50) {
              alert('<fmt:message key="ktvtabmis.listktvtabmis.warning.ma.length"/>');
              return;
          }
          else if (f.ten.value.length > 100) {
              alert('<fmt:message key="ktvtabmis.listktvtabmis.warning.ten.length"/>');
              return;
          }
      }
      if (type == 'close') {
...
<div class="box_common_conten">
  <html:form action="KTVTabmisAddExcAction" method="post">
        ...
        <tr>
          <td class="title" colspan="6" bordercolor="#e1e1e1"
            ...
            <span>&nbsp;&nbsp;&nbsp;&nbsp;<font color="Gray">
                <fmt:message key="ktvtabmis.addktvtabmis.title.themmoiktvtabmis"/>
              </font></span>
          </td>
        </tr>
      </tbody>
          ...
          <table width="45%" cellspacing="0" cellpadding="1"
            ...
            <tbody>
              ...
              <tr>
               ...
               <tr>
                <td width="30%" align="right" class="promptText"
                    bordercolor="#e1e1e1">
                ...
                <html:select 
                       ...
                       styleClass="fieldText" style="width:100%" 
      ...
      <tbody align="center" bordercolor="#e1e1e1">
        <tr>
          <td bordercolor="#e1e1e1">
            ...
            <button type="button" onclick="sbKTVTabmis('close')" accesskey="o"
                    class="ButtonCommon">
