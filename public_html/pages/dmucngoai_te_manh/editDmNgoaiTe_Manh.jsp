...
<div class="box_common_conten">
  <html:form action="updateExcDMNgoaiTe_ManhAction" method="post" styleId="TCuuDMuc" >
    ...
    <tbody>
      <tr>
        ...
        <td background="<%=request.getContextPath()%>/styles/images/T2.jpg" width="75%">
          <span class=title2>Ngừng hoạt động ngoại tệ mạnh </span>
        </td>
      ...
      <fieldset>
        ...
        <tr>
          <td align="right" width="15%">Mã ngoại tệ</td>
                ...
                <html:select styleClass="selectBox" property="ma" value='<%=request.getParameter("ma")%>'
                             disabled="true" styleId="ma" style="width:50%;height:20px">
                <html:optionsCollection value="ma" label="ma" name="loaitien"/>
                </html:select>
                </td>
                <td align="right">Ngày hết hiệu lực</td>
                <td align="left" valign="middle">
                <html:text property="ngay_het_hieu_luc" styleId="ngay_het_hieu_luc"
                           styleClass="promptText" onmouseout="UnTip()"
                           onkeypress="dateBlockKey(event)"
                           onblur="javascript:mask(this.value,this,'2,5','/');CheckDate(this);CheckDateOnClient('ngay_het_hieu_luc');textlostfocus(this);"
            ...
            <html:hidden property="ma" styleId="ma" value='<%=request.getParameter("ma")%>'></html:hidden>
            </td>
            <td align="left">
...
<script type="text/javascript">
  function check(type) {
      ...
      if (type == 'save') {
          ...
          var ngay_het_hieu_luc = jQuery('#ngay_het_hieu_luc').val();
          ...
          else if (ngay_het_hieu_luc == null || ngay_het_hieu_luc == '') {
              alert(GetUnicode('Hãy nhập ngày hết hiệu lực'));
              jQuery('#ngay_het_hieu_luc').focus();
              return false;
          }
          document.getElementById("bt").disabled = true;
          f.action = 'updateExcDMNgoaiTe_ManhAction.do';
      }
