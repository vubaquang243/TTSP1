...
function fillDataXNDC(act, ngay_dc, receive_bank, ttsp_id, pht_id, tr_id,loai_tien,tthai) {
    document.forms[0].action= act + "?rowSelected=" + tr_id+
                                    "&ngay_dc=" + ngay_dc +
                                    "&receive_bank=" + receive_bank+
                                    "&ttsp_id=" + ttsp_id+
                                    "&pht_id=" + pht_id+
                                    "&loai_tien=" + loai_tien+
                                    "&tthai_dxn_thop=" + tthai;
    document.forms[0].submit();
}


function fillDataDuyetXNDC(act, mt_id, tr_id) {
    document.forms[0].action= act + "?mt_id=" + mt_id + "&rowSelected=" + tr_id;
    document.forms[0].submit();
}

function fillDataDuyetXNTH(act, id,ngay_dc, tr_id, receive_bank,loai_tien,tthai_dxn_thop) {
    document.forms[0].action= act + "?id=" + id + "&rowSelected=" + tr_id+ "&ngay_dc=" + ngay_dc + "&receive_bank="+receive_bank+"&loai_tien="+loai_tien+"&tthai_dxn_thop="+tthai_dxn_thop; 
    document.forms[0].submit();
}
...
function fillDataTHopDC1(act,mt_id, id, kq_id,send_bank, tr_id) {
    document.forms[0].action= act + "?mt_id=" + mt_id + "&id="+id+ "&kq_id="+kq_id+"&send_bank="+send_bank+"&rowSelected=" + tr_id;
    document.forms[0].submit();
}
