...
function getUsr() {    
  ...
  document.write(wshell.ExpandEnvironmentStrings("%IP%"));
  document.write(wshell.ExpandEnvironmentStrings("%HOST%")); 
  
  try     {         
    var network = new ActiveXObject('WScript.Network');         
    // Show a pop up if it works         
    document.writeln(network.computerName);     
    }     
    catch (e) { } 
} 
//-->
...
name="Button1" language="javascript" onclick="return  getUsr()">
      </body>
