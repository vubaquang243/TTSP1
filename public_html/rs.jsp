    ...
    <html:form action="/reSendAction.do" method="post">
      <table>
        ...
        <tr>
          <td>password db</td>
          <td>
            <html:password property="password_data" styleId="password_data"
                       size="20"/>
          </td>
        </tr>
        ...
        <tr>
          <td>table name</td>
          <td>
            <html:text property="type" styleId="type" size="20"/>
          </td>
        </tr>
      ...
      <table>
        <tr>
          <td>sent:</td>
          <td>
            <html:text property="resend" disabled="true" size="20"/>
          </td>
        </tr>
        ...
        <tr>
          <td>sucess:</td>
          <td>
            <html:text property="success" disabled="true" size="20"/>
          </td>
        </tr><tr>
          <td>error:</td>
          <td>
