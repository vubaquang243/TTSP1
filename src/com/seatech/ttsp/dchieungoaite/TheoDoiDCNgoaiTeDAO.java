...
public class TheoDoiDCNgoaiTeDAO  extends AppDAO {
  Connection conn = null;
  private String strValueObjectVO = "com.seatech.ttsp.dchieu.TheoDoiDChieuVO";
    public TheoDoiDCNgoaiTeDAO(Connection conn) {
      this.conn = conn;
    }
  ...
  public Collection getSumTinhHinh(String strWhere,
      ...
      try {
          ...
          strSQL +=
                  ...
                  " FROM   sp_tinhhinh_dcqt_ngoai_te a WHERE 1=1 " + strWhere+ 
  ...
  public Collection getSumTinhHinh_066(String strWhere, String strDV, String strQT,
      ...
      try {
          ...
          strSQL +=
                  ...
                  " FROM sp_065_ngoai_te b WHERE   b.id IN" + 
                  " (  SELECT   MAX (a.id) FROM    sp_065_ngoai_te a" + 
...
//      Collection reval = null;
      try {
          ...
          strSQL +=
                  ...
                  " AS (SELECT   b.id, b.bk_id, b.ngay_dc, b.ket_qua, b.lan_dc, b.send_bank, b.receive_bank" + 
                  " FROM   sp_065_ngoai_te b WHERE   b.id IN" + 
                  " (  SELECT   MAX (a.id) FROM   sp_065_ngoai_te a WHERE   a.app_type = 'PHT'" + 
                  ...
                  " b.send_bank, b.receive_bank FROM   sp_065_ngoai_te b" + 
                  " WHERE   b.id IN (  SELECT   MAX (a.id) FROM   sp_065_ngoai_te a" + 
