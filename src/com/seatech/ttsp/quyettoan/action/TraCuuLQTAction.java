            ...
            if (!checkPermissionOnFunction(request, "QTOAN.TRACUU")) {
                ...
                if (actionBack != null &&
                  ...
                  if (so_tien_back != null &&
                      ...
                      if(tcg_loai_tien_back != "" && !STRING_EMPTY.equals(tcg_loai_tien_back)){
                      if(tcg_loai_tien_back.equals("VND")){
                        so_tien_back = so_tien_back.replace(".", "");
                      }else{
                        so_tien_back = so_tien_back.replace(",", "");
                      }
                      }
                ...
                if(f.getSoTien() != null && !STRING_EMPTY.equals(f.getSoTien())){
                    String a = f.getSoTien();
                    if(!f.getTcg_loai_tien().equals("")){
                        if(f.getTcg_loai_tien().equals("VND")){
                          a = a.replace(".", "");
                        }else{
                          a = a.replace(",", "");
                        }
                  ...
                  params.add(new Parameter(a, true));
                }
