...
public class QuyetToanForm extends ActionForm {
    ...
    private String ttv_chuyen_ks;
    private String ngay_chuyen_ks;
    private String ktt_ks;
    ...
    public void setTtv_chuyen_ks(String ttv_chuyen_ks) {
        this.ttv_chuyen_ks = ttv_chuyen_ks;
    }

    public String getTtv_chuyen_ks() {
    ...
    public void setKtt_ks(String ktt_ks) {
        this.ktt_ks = ktt_ks;
    }

    public String getKtt_ks() {
        return ktt_ks;
    }
    ...
    public void setTt_in(String tt_in) {
        this.tt_in = tt_in;
    }

    public String getTt_in() {
        return tt_in;
    }
