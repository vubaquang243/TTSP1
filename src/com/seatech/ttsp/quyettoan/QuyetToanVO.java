...
public class QuyetToanVO {
  ...
  private String mt_refid;
    ...
    private String ten;
    private String lai_phi;
    private String ten_kb_tw;
    private String ten_kb_huyen;
    private String tong_so_lenh;
    private String noi_dung_ky;
    private BigDecimal tong_tien;
    private String tong_mon;
    private String mo_ta_trang_thai_dv;
    ...
    public void setLai_phi(String lai_phi) {
        this.lai_phi = lai_phi;
    }

    public String getLai_phi() {
        return lai_phi;
    }

    public void setTen_kb_tw(String ten_kb_tw) {
        this.ten_kb_tw = ten_kb_tw;
    }

    public String getTen_kb_tw() {
        return ten_kb_tw;
    }
    ...
    public void setTong_so_lenh(String tong_so_lenh) {
        this.tong_so_lenh = tong_so_lenh;
    }

    public String getTong_so_lenh() {
        return tong_so_lenh;
    }
    ...
    public void setTong_mon(String tong_mon) {
        this.tong_mon = tong_mon;
    }

    public String getTong_mon() {
        return tong_mon;
    }

    public void setMo_ta_trang_thai_dv(String mo_ta_trang_thai_dv) {
        this.mo_ta_trang_thai_dv = mo_ta_trang_thai_dv;
    }

    public String getMo_ta_trang_thai_dv() {
        return mo_ta_trang_thai_dv;
    }

    public void setErr_desc_dv(String err_desc_dv) {
        this.err_desc_dv = err_desc_dv;
    }

    public String getErr_desc_dv() {
        return err_desc_dv;
    }
    ...
    public void setMt_refid(String mt_refid) {
        this.mt_refid = mt_refid;
    }

    public String getMt_refid() {
        return mt_refid;
    }

    public void setTtin_lenh_goc(String ttin_lenh_goc) {
        this.ttin_lenh_goc = ttin_lenh_goc;
    }

    public String getTtin_lenh_goc() {
