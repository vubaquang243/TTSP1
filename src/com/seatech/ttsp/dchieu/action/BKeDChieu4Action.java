...
import com.seatech.ttsp.dchieu.BKeDChieu4DAO;
import com.seatech.ttsp.dchieu.BKeDChieu4VO;
...
import com.seatech.ttsp.dchieu.form.BKeDChieu4Form;
...
public class BKeDChieu4Action extends AppAction {
    public ActionForward list(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            BKeDChieu4DAO dao = new BKeDChieu4DAO(conn);
            //            BKeDChieuVO vo = new BKeDChieuVO();
            BKeDChieu4Form frm = (BKeDChieu4Form)form;
            ...
            ArrayList<BKeDChieu4VO> colTHBK =
                (ArrayList<BKeDChieu4VO>)dao.getBKeDChieu4CTiet(strWhere, null);
            if (colTHBK.isEmpty()) {
    ...
    public ActionForward printAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            conn = getConnection(request);
            BKeDChieu4Form f = (BKeDChieu4Form)form;
