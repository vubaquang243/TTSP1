...
import com.seatech.ttsp.dchieu.DChieu3NgoaiTeCTietDAO;
...
import com.seatech.ttsp.dchieu.KQDChieu3NgoaiTeCTietVO;
import com.seatech.ttsp.dchieu.KQDChieu3NgoaiTeDAO;
import com.seatech.ttsp.dchieu.KQDChieu3NgoaiTeVO;
import com.seatech.ttsp.dchieu.form.DChieu3NgoaiTeForm;
...
public class DChieu3NgoaiTeAction extends AppAction {


    public DChieu3NgoaiTeAction() {
        super();
    }
    ...
    public ActionForward list(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            DChieu3NgoaiTeForm f = (DChieu3NgoaiTeForm)form;
            String idxNH =
    ...
    public ActionForward view(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            KQDChieu3NgoaiTeVO kQDChieu4VO =
            ...
            if (kQDChieu4VO != null) {
                ...
                vParam.add(new Parameter(kQDChieu4VO.getId(), true));
                vParam.add(new Parameter(kQDChieu4VO.getId(), true));
                KQDChieu3NgoaiTeCTietDAO kQDChieu4CTietDAO =
                    new KQDChieu3NgoaiTeCTietDAO(conn);
                ...
                if (colTongKQDChieu != null) {
                    ...
                    KQDChieu3NgoaiTeCTietVO kQDChieu4CTietVO = null;
                    while (iter.hasNext()) {
                        kQDChieu4CTietVO = (KQDChieu3NgoaiTeCTietVO)iter.next();
                        DChieu3NgoaiTeVO dChieu4VO = null;
                        Iterator iter2 = colDChieuDetail.iterator();
                        while (iter2.hasNext()) {
                            dChieu4VO = (DChieu3NgoaiTeVO)iter2.next();
                ...
                KQDChieu3NgoaiTeCTietDAO dchieu4CtietDAO =
                    new KQDChieu3NgoaiTeCTietDAO(conn);
                vParam = new Vector();
                vParam.add(new Parameter(kQDChieu4VO.getId(), true));
            ...
            Type listType = new TypeToken<Collection<DChieu3NgoaiTeVO>>() {
            }.getType();
            String strJson;
            if (check) {
            ...
            listType = new TypeToken<Collection<KQDChieu3NgoaiTeCTietVO>>() {
                }.getType();
