...
public class DChieu1Form extends ActionForm {
  private String id; 
  ...
  private long chi_tcong;
  private long thu_tcong;
  
  private String trang_thai_bkdc;
  private String trang_thai_kqdc;
  private String trang_thai_kq;//Them truong trang thai ket qua doi chieu
  ...
  private String tthai_duyet;
    ...
    public void setChi_tcong(long chi_tcong) {
        this.chi_tcong = chi_tcong;
    }

    public long getChi_tcong() {
        return chi_tcong;
    }

    public void setThu_tcong(long thu_tcong) {
        this.thu_tcong = thu_tcong;
    }

    public long getThu_tcong() {
        return thu_tcong;
    }
