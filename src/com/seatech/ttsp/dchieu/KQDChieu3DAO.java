...
public class KQDChieu3DAO extends AppDAO {

    private String strValueObject = "com.seatech.ttsp.dchieu.KQDChieu3DAO";
    private String strValueObjectVO = "com.seatech.ttsp.dchieu.KQDChieu3VO";
    Connection conn = null;

    public KQDChieu3DAO(Connection conn) {
        this.conn = conn;
    }
    public KQDChieu3VO getKQDChieu3(String strWhereClause) throws Exception{
      ...
      "       a.ket_qua\n" + 
      "  FROM sp_kq_dc3 a where (1=1) "+ strWhereClause;
...
//            daoEx.printStackTrace();
    ...
    public int updateKQDC3(KQDChieu3VO vo) throws Exception {
        int exc = 0;
        Vector v_param = new Vector();
        StringBuffer sqlBuff = new StringBuffer("");
        sqlBuff.append(" UPDATE sp_kq_dc3 SET ngay_thien_dc= sysdate ,");
  ...
  public KQDChieu3VO getTenNH(String whereClause,
...
//          daoEx.printStackTrace();
  ...
  public KQDChieu3VO getKQDC3(String strWhere,
                                   Vector vParam) throws Exception {
      ...
      try {
          ...
          strSQL +=
                  ...
                  " FROM	sp_kq_dc3 a, sp_nsd b WHERE	a.creator = b.id" + strWhere;
          KQDChieu3VO dcVO =
