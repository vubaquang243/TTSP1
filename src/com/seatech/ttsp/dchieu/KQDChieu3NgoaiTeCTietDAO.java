...
public class KQDChieu3NgoaiTeCTietDAO extends AppDAO {
  private String strValueObjectVO ="com.seatech.ttsp.dchieu.KQDChieu3NgoaiTeCTietVO";
  Connection conn = null;

  public KQDChieu3NgoaiTeCTietDAO(Connection conn) {
      this.conn = conn;
  }


  public Collection getKQDChieu4CTietList(String strWhere, Vector vParam) throws Exception {
      ...
      try {
          ...
          DAOException daoEx =new DAOException(strValueObjectVO + ".getKQDChieu4CTietList(): " +
                               ex.getMessage(), ex);
//          daoEx.printStackTrace();
  ...
  public Collection getTongKQDChieu4(Vector vParam) throws Exception {
      Collection reval = null;
      try {
          String strSQL =" SELECT (SELECT count(*)\n" + 
          "  FROM sp_kq_dc3_ngoai_te_ctiet a\n" + 
          "    where  mt_type='900'\n" + 
          ...
          DAOException daoEx =new DAOException(strValueObjectVO + ".getTongKQDChieu4(): " +
                               ex.getMessage(), ex);
//          daoEx.printStackTrace();
          throw daoEx;
      }
