...
public class BKeDChieuDAO extends AppDAO {
    
  Connection conn = null;
  private String strValueObjectVO = "com.seatech.ttsp.dchieu.BKeDChieuVO";

  public BKeDChieuDAO(Connection conn) {
      this.conn = conn;
  }
...
//          daoEx.printStackTrace();
  ...
  public Collection getBKeDChieu1CTiet(String strWhere,
      ...
      try {
          ...
          String strSQL = "";
          strSQL += "SELECT a.id, b.id kq_id, a.lan_dc, a.loai_dc, to_char(a.ngay_dc,'DD/MM/YYYY') ngay_dc, a.send_bank, a.receive_bank, a.created_date, a.creator, a.manager, a.verified_date, " + 
                  ...
                  " b.trang_thai trang_thai_kq,a.loai_tien FROM sp_bk_dc1 a, sp_065 b WHERE 1=1 and a.id=b.bk_id(+) "+ strWhere;
          reval =
                  executeSelectStatement(strSQL.toString(), vParam, strValueObjectVO,
                                         conn);
      } catch (Exception ex) {
...
//          daoEx.printStackTrace();
  ...
  public Collection getCTietDChieu1(String strWhere, Vector vParam) throws Exception {
      ...
      try {
          ...
          String strSQL ="SELECT	a.id, a.bk_id, a.mt_id, a.send_bank, a.receive_bank, to_char(a.send_date,'DD-MM-YYYY HH24:mi:ss') send_date," + 
          ...
          "  FROM	sp_bk_dc1_ctiet a, sp_dm_ngan_hang b, sp_bk_dc1 c" + 
          " WHERE		 1 = 1 AND a.bk_id = c.id AND c.receive_bank = b.ma_nh";          
          strSQL += strWhere;
          reval = executeSelectStatement(strSQL.toString(), vParam, strValueObjectVO,conn);
      } catch (Exception ex) {
          DAOException daoEx =new DAOException(strValueObjectVO + ".getCTietDChieu3(): " +
