...
public class DChieu4DAO extends AppDAO {


    String strValueObjectVO = "com.seatech.ttsp.dchieu.DChieu4VO";
    String strValueObjectVO2 = "com.seatech.ttsp.dchieu.thopDCQTTQuocVO";
    Connection conn = null;

    public DChieu4DAO(Connection conn) {
        this.conn = conn;
    }
...
//          daoEx.printStackTrace();
    ...
    public int updateBKDC4(DChieu4VO vo) throws Exception {
        int exc = 0;
  ...
  public DChieu4VO getMaSGD(String whereClause,
      ...
      try {
          ...
          DChieu4VO vo =
              (DChieu4VO)findByPK(strSQL.toString(), params,
