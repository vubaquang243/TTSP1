...
public class KQDChieu3NgoaiTeDAO extends AppDAO {

    private String strValueObject = "com.seatech.ttsp.dchieu.KQDChieu3NgoaiTeDAO";
    private String strValueObjectVO = "com.seatech.ttsp.dchieu.KQDChieu3NgoaiTeVO";
    Connection conn = null;

    public KQDChieu3NgoaiTeDAO(Connection conn) {
        this.conn = conn;
    }

    public KQDChieu3NgoaiTeVO getKQDChieu4(String strWhereClause) throws Exception {
        String strSQL =
        ...
        return (KQDChieu3NgoaiTeVO)findByPK(strSQL, strValueObjectVO, conn);
    }
    ...
    public int updateKQDC4(KQDChieu3NgoaiTeVO vo) throws Exception {
        int exc = 0;
    ...
    public KQDChieu3NgoaiTeVO getTenNH(String whereClause,
        ...
        try {
            ...
            strSQL +=
                    ...
                    whereClause;
            KQDChieu3NgoaiTeVO phtVO =
                (KQDChieu3NgoaiTeVO)findByPK(strSQL.toString(), params,
    ...
    public KQDChieu3NgoaiTeVO getKQDC4(String strWhere,
                                Vector vParam) throws Exception {
        ...
        try {
            ...
            strSQL +=
                    ...
                    strWhere;
            KQDChieu3NgoaiTeVO dcVO =
                (KQDChieu3NgoaiTeVO)findByPK(strSQL.toString(), vParam, strValueObjectVO,
                                      conn);
            return dcVO;
        } catch (Exception ex) {
            DAOException daoEx =
