...
public class BKeDChieu3NgoaiTeVO {
  ...
  private BigDecimal tong_thu;
  private BigDecimal tong_chi;
  private BigDecimal so_du_cuoi_ngay;
  ...
  private BigDecimal so_mon_thu_tcong;
  ...
  private String loai_tien;
    ...
    public void setTong_thu(BigDecimal tong_thu) {
        this.tong_thu = tong_thu;
    }

    public BigDecimal getTong_thu() {
        return tong_thu;
    }

    public void setTong_chi(BigDecimal tong_chi) {
        this.tong_chi = tong_chi;
    }

    public BigDecimal getTong_chi() {
        return tong_chi;
    }

    public void setSo_du_cuoi_ngay(BigDecimal so_du_cuoi_ngay) {
        this.so_du_cuoi_ngay = so_du_cuoi_ngay;
    }

    public BigDecimal getSo_du_cuoi_ngay() {
    ...
    public void setSo_mon_thu_tcong(BigDecimal so_mon_thu_tcong) {
        this.so_mon_thu_tcong = so_mon_thu_tcong;
    }

    public BigDecimal getSo_mon_thu_tcong() {
    ...
    public void setF32as1(String f32as1) {
        this.f32as1 = f32as1;
    }

    public String getF32as1() {
        return f32as1;
    }
