...
import com.seatech.ttsp.reports.bkltt.forms.BKLTTDenRptForm;
...
public class THLTTDenRptAction extends AppAction {
    public THLTTDenRptAction() {
        super();
    }
  ...
  public static final String REPORT_DIRECTORY = "/report";
      ...
      public ActionForward list(ActionMapping mapping, ActionForm form,
          ...
          try {
              conn = getConnection();
              BKLTTDenRptForm f = (BKLTTDenRptForm)form;
